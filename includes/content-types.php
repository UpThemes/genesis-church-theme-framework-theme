 ...
 * List page templates in order of priority for churchy_sidebar_enabled() and ctfw_redirect_archives_to_pages().
 *
 ...
 */
function churchy_update_content_types( $content_types ) {
...
add_filter( 'ctfw_content_types', 'churchy_update_content_types' );
