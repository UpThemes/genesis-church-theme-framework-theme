 ...
 * @since 1.0
 */
function churchy_add_theme_support_ctc() {
	...
	add_theme_support( 'ctc-people', array(
		...
		'field_overrides' => array(
			'_ctc_person_email' => array(
				'desc' => sprintf( __( 'The WordPress <a href="%s" target="_blank">antispambot</a> function is used to help deter automated email harvesting.', 'churchy' ), 'http://codex.wordpress.org/Function_Reference/antispambot' ),
			),
		),
	) );
...
add_action( 'after_setup_theme', 'churchy_add_theme_support_ctc', 9999 );
